...
ВАЖНО: не приписывай кандидату навыки или опыт, которых нет в резюме буквально. Если в резюме есть только общая работа с SQL/базами данных, а вакансия требует конкретных задач администрирования (patching, backup/recovery, RMAN, Data Guard, RAC, управление доступом) — это НЕ то же самое, и низкий процент здесь уместнее высокого. Общий опыт с технологией ≠ опыт в конкретной специализации/роли.
