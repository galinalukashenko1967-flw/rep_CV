...
СОГЛАСОВАННОСТЬ percent И reasoning — ОБЯЗАТЕЛЬНО: если в reasoning ты пишешь, что ключевого профильного опыта/навыка НЕТ в резюме (например: "не хватает бухгалтерского опыта", "нет опыта администрирования", "требует другой специализации") — percent должен быть НИЗКИМ (0-20), а не средним. Не пиши reasoning вида "ключевого опыта нет" и одновременно не ставь 25-40% — это противоречие. Средний процент (30-50%) допустим только когда реально ЕСТЬ частичное, но настоящее пересечение (например, смежный инструмент или похожая, но не идентичная задача), а не когда единственная связь — совпадение слова из ключевых слов поиска.
